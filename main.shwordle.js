(this.shwordle = this.shwordle || {}),
  (this.shwordle.bundle = (function (e) {
    "use strict";
    function a(e) {
      return (a =
            ...
            value: function () {
              ...
              this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                (this.shadowRoot.querySelector("#hash").textContent =
                  null === (e = window.shwordle) || void 0 === e
                    ? void 0
                    : e.hash),
    ...
    Ca("config", "G-2SSGMHY3NP", {
      app_version:
        null === (Ea = window.shwordle) || void 0 === Ea ? void 0 : Ea.hash,
      debug_mode: !1,
    });
    var Ta = [
      "aah",
    ...
    var La = ['bar', 'log', 'toy', 'bed', 'leg', 'ale', 'dug', 'her', 'box', 'hot', 'ton', 'pet', 'fun', 'pry', 'bay', 'red', 'moo', 'web', 'lot', 'fab', 'new', 'off', 'pap', 'vid', 'lop', 'mat', 'max', 'let', 'jig', 'tie', 'rad', 'pit', 'cub', 'are', 'dad', 'mug', 'oar', 'not', 'bod', 'sib', 'shy', 'rye', 'led', 'lag', 'roe', 'war', 'cat', 'row', 'sag', 'win', 'eel', 'cry', 'end', 'tip', 'ilk', 'pea', 'elm', 'dry', 'jib', 'lie', 'rip', 'hop', 'hug', 'bye', 'pub', 'win', 'row', 'nag', 'awl', 'jab', 'yap', 'emu', 'how', 'use', 'rub', 'bag', 'pan', 'jot', 'art', 'see', 'was', 'cog', 'tad', 'med', 'gag', 'pal', 'din', 'mow', 'cop', 'rat', 'zip', 'nab', 'bop', 'tub', 'jam', 'wed', 'top', 'caw', 'him', 'bun', 'cab', 'bin', 'ion', 'nip', 'rug', 'got', 'set', 'lay', 'jar', 'yen', 'poi', 'bap', 'cay', 'fed', 'oat', 'rot', 'why', 'mod', 'vat', 'pin', 'tan', 'tap', 'pay', 'gin', 'rod', 'and', 'nap', 'say', 'fat', 'tot', 'rig', 'dye', 'eye', 'hit', 'car', 'wig', 'lap', 'tar', 'tie', 'dew', 'mad', 'lox', 'bid', 'cow', 'hoe', 'met', 'tea', 'old', 'jug', 'jog', 'ban', 'con', 'urn', 'pip', 'add', 'gem', 'man', 'inn', 'run', 'son', 'coy', 'net', 'lug', 'mop', 'hum', 'wag', 'oil', 'boo', 'bug', 'ran', 'lee', 'mop', 'won', 'tug', 'sup', 'foe', 'egg', 'jab', 'lye', 'nut', 'yet', 'ivy', 'lab', 'dim', 'wry', 'cot', 'hop', 'maw', 'ego', 'raw', 'fib', 'oak', 'gun', 'yet', 'ham', 'buy', 'jog', 'max', 'odd', 'tin', 'dot', 'you', 'sin', 'sip', 'bet', 'sub', 'git', 'pop', 'hay', 'wet', 'dub', 'tax', 'peg', 'god', 'jaw', 'all', 'men', 'fit', 'dig', 'fin', 'eve', 'kid', 'cap', 'arm', 'sow', 'pet', 'pot', 'coo', 'jig', 'ram', 'wit', 'sax', 'cam', 'paw', 'cup', 'cut', 'mag', 'mar', 'pop', 'aim', 'fib', 'dab', 'fan', 'ear', 'did', 'rum', 'elf', 'pat', 'bog', 'ail', 'sat', 'any', 'fig', 'lad', 'eat', 'she', 'lag', 'tat', 'pat', 'ram', 'jet', 'hog', 'oil', 'pup', 'nor', 'nod', 'nub', 'dim', 'big', 'pay', 'ray', 'bog', 'hat', 'rib', 'gym', 'try', 'day', 'den', 'bit', 'soy', 'sew', 'wow', 'hit', 'tag', 'bad', 'ice', 'pun', 'boy', 'get', 'mew', 'lid', 'set', 'rap', 'out', 'max', 'lie', 'era', 'dip', 'era', 'bag', 'cod', 'jam', 'rig', 'doe', 'mew', 'now', 'his', 'the', 'far', 'ten', 'rag', 'dam', 'way', 'pig', 'top', 'sun', 'toe', 'hum', 'yin', 'bot', 'cap', 'owl', 'ill', 'dog', 'ace', 'gum', 'had', 'tug', 'tum', 'net', 'pox', 'rib', 'for', 'bum', 'bow', 'bib', 'aid', 'yap', 'err', 'sip', 'jib', 'hen', 'pus', 'gin', 'tax', 'but', 'air', 'gay', 'bow', 'pod', 'wet', 'sea', 'rap', 'tap', 'rag', 'tow', 'our', 'sit', 'tee', 'pew', 'law', 'zoo', 'tag', 'ink', 'tan', 'bee', 'too', 'pen', 'sap', 'gut', 'hey', 'dip', 'bat', 'rut', 'can', 'sap', 'sop', 'lap', 'hut', 'kit', 'lip', 'has', 'pie', 'mad', 'lax', 'hem', 'hag', 'fog', 'ore', 'tab', 'ire', 'fad'],
      Ia = "present",
      Ma = "correct",
      Oa = "absent";
    ...
    var Ha = new Date(2022, 1, 2, 0, 0, 0, 0);
    function Na(e, a) {
      var s = new Date(e),
